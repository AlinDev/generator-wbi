...
import { alinBogdanApiFailure, alinBogdanApiSuccess, ALIN_BOGDAN_API } from "../alinBogdan.actions";
...
const successActions = (response) => [alinBogdanApiSuccess(response),hideLoading({id:"alinBogdan"})];
const failActions = (error) => [alinBogdanApiFailure(error),hideLoading({id:"alinBogdan"})];
